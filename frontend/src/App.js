  ...
  return (
    ...
    <BrowserRouter>
       <nav className="navbar navbar-expand navbar-dark bg-dark">
        ...
        <div className="nav-bag">
          ...
          <div className="content-container">
            <Routes>
              ...
              <Route path="/checkout-success" element={<AuthVerify><CheckoutSuccess /></AuthVerify>} />
            ...
            <Route path="/orders" element={<AuthVerify><Orders /></AuthVerify>} />
            <Route path="/ListOrders" element={<ListOrders />} />
            <Route path="/mod" element={<BoardModerator />} />
            <Route path="products" element={<Products />}></Route>
            {/* <Route path="/admin" element={<BoardAdmin />} /> */}
              <Route path="/admin" element={<AuthVerify><Dashboard /></AuthVerify>}>
        ...
        {window.location.pathname !== '/admin' && window.location.pathname !== '/ListOrders'&&<Footer />}
