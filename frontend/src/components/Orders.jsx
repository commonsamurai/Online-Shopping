...
const [postIndex, setpostIndex ] = useState('')
   ...
   const AddOrder = async (ref) => {
    ...
    //      await axios.post(ORDER_URL, orders).then(res => {
  ...
  return (
        ...
        <Grid item container>
          <Typography variant="h3" fontStyle={"oblique"} paddingBottom = "17px">Shipping Details</Typography>
               ...
               <Formik >
      <Form noValidate
            autoComplete="off"  onSubmit={AddOrder} >
      ...
      <Grid item xs={12} sm={6}>
        <TextField
          ...
          required = {true}
           ...
           helperText = "Min length must be one character"
      ...
      <Grid item xs={12} sm={6}>
        <Field
          ...
          helperText = "Code should be less than 5 numbers"
        />
      </Grid>
    </Grid>
