...
public class UserController {
	...
	@GetMapping ("/user/{id}")
	public Optional<Optional<User>> getUserById(@PathVariable int id) throws UserDoesntExistException {
	...
	@PutMapping("/user/{id}")
	public ResponseEntity<Void> update( @Valid @RequestBody User user,@PathVariable User id) {
